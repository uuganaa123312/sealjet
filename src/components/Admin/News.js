...
const News = () => {
  ...
  return (
    <div className="mx-4 text-[#244437] font-[roboto]">
      <div className="text-xl font-bold my-2">Захиалга</div>
      <div className="flex">
        <div className="flex-1 mr-4">
          <div className="mt-3">
            <label className="block tracking-wide mb-1">Мэдээний гарчиг</label>
            <input
