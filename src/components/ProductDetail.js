    ...
    <div className="animate-fade max-w-7xl mx-auto">
      ...
      <div className="flex flex-col items-center justify-center sm:mt-[116px]">
        {data ? (
                ...
                {data.material.length > 0 && (
                  <>
                    ...
                    <div className="flex justify-between flex-col md:flex-row md:gap-5">
                      <div>
                        {data.material.filter((el) => parseInt(el.type) === 1)
                          .length > 0 && (
                      ...
                      <div>
                        {data.material.filter((el) => parseInt(el.type) === 2)
                          .length > 0 && (
                      ...
                      <div>
                        {data.material.filter((el) => parseInt(el.type) === 3)
                          .length > 0 && (
                      ...
                      <div>
                        {data.material.filter((el) => parseInt(el.type) === 4)
                          .length > 0 && (
                          <div className="font-semibold">Пүрш</div>
                        )}
          ...
          <div className="text-center my-8">Хоосон байна.</div>
        )}
      </div>
                ...
                <div className="mr-4 rounded-xl bg-white" key={el.id}>
                  <div className="flex items-center justify-center p-2">
                    <img
                      ...
                      alt=""
                      className="rounded-t-xl h-[94px] sm:h-[102px] md:h-[128px] lg:h-[170px] xl:h-[200px] cursor-pointer"
